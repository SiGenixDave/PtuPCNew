 ...
 *                                      1.  Add the instruction '3. Move the mouse to the 'virtual machine' down arrow box at the top of the screen. Click the down arrow box once
 *                                          and select 'removable devices'. Click on 'network adapter' and ensure that the text indicates 'disconnect'. If true, no further action is
 *                                          required.  If it indicates 'connect', then click 'connect' and the network adapter will be enabled'.
 *                                      2.  Change this message type to 'Information'.
 *                                      3.  Report the actual error code and associated message returned from the Windows Command File in the event that the FTP download from the
 *                                          VCU is unsuccessful.
 *                                      4.  Check that the required XML configuration file and associated help file were downloaded from the VCU and, if not, to report the error.
 * 
 */
