 ...
 *                                      
 *                                  Modifications
 *                                  1.  Hid the 'Connection' Label and corresponding Legend as this value is fixed to 'Direct'. This releases slightly more vertical
 *                                      real-estate to display the 'Exit' and 'Help' buttons.- Ref.: 1.
 *                                      
 *                                  2.  Hid the: 'm_ButtonMaintenanceSpare1'; and 'm_ButtonAdministrationSWUpload' buttons and modified the Text associated with the
 *                                      'm_ButtonPasswordProtection' button from '"Other Functio&ns' to '&Password Protection'. - Ref.: 1.
 *                                      
 */
...
namespace Bombardier.PTU
{
    partial class ControlPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.m_LabelConnection.Visible = false;
            // 
            // m_LabelLocation
            // 
            ...
            this.m_LegendConnection.Visible = false;
            // 
            // m_LegendWibuBox
            // 
            ...
            this.m_ButtonMaintenanceSpare1.Visible = false;
            ...
            this.m_ButtonAdministrationSWUpload.Visible = false;
            ...
            this.m_ButtonPasswordProtection.Text = "&Password Protection";
