...
/*
 *  09/30/15    1.14    K.McD       References
 ...
 *                                      
 *                                  Modifications
 *                                  1.  Added the following Keys: KeyFormDataStreamReplay; KeyFormViewTestResults.   
 * 
 */
...
namespace Common
{
    ...
    public class CommonConstants
    {
        ...
        /// </summary>
        public const string KeyFormViewTestResults = "FormViewTestResults";

        /// <summary>
        /// Key corresponding to the 'DataStreamReplay' form. Value: "FormDataStreamReplay".
        /// </summary>
        public const string KeyFormDataStreamReplay = "FormDataStreamReplay";
        #endregion - [Forms] -
