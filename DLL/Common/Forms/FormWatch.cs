 ...
 *                                  
 *                                  Modifications
 *                                  1.  Modified the ConfigureDisplayPanel() method such that the new Panel control is not added to the 'displayPanel' parameter if
 *                                      the last column of the workset does not contain any watch variables AND no header text is defined. This ensures that the
 *                                      horizontal scroll bar is not displayed.
 */
