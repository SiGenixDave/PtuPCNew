 ...
 *  Project:    Common
 * 
 *  File name:  VcuCommunication32.cs
 * 
 *  Revision History
 *  ----------------
 * 
 ...
 * 
 *  09/29/10    1.1     K.McD           1.  Added SendVariable() method and restructured file.
 * 
 *  03/18/11    1.2     K.McD           1.  Modified a number of comments and XML tags.
 * 
 *  04/27/11    1.3     K.McD           1.  Added the communication methods required to configure the chart recorder and set the chart mode.
 *
 *  09/21/11	1.4		Sean.D			1.	Added the SetWatchSize method to set a new watch size.
 *  
 *  02/27/14    1.5     K.McD           1.  Changed the order of the methods to match the order defined in the prototype 
 *                                          list and Com.cpp.
 ...
 *                                      
 *                                      Modifications
 *                                      1.  Renamed class to VcuCommunication32. Ref.: 1.1.
 *                                      2.  Changed the DLLImport parameter to VcuCommunication32.dll. Ref.: 1.1.
 *                                      3.  Modified the SetTimeDate() and GetTimeDate() methods to include an additional parameter that specifies
...
{
    /// <summary>
    /// A managed wrapper class to allow the unmanaged C++ functions associated with the VcuCommunication32 dynamic link library (DLL) to be 
    ...
    /// </summary>
    public class VcuCommunication32
    {
        #region - [VcuCommunication32.dll - Comm.cpp Prototypes] -
        /*
        ...
        */
        #endregion - [VcuCommunication32.dll - Comm.cpp Prototypes] -

        #region - [VcuCommunication32.dll - Comm Functions] -
        /// <summary>
        ...
        public static extern unsafe short InitCommunication(short protocol, string portID, int baudRate, short bitsPerByte, short parity,
                                                            short stopBits);
        ...
        /// <summary>
        /// Set the watch variables that are to be monitored by the target hardware i.e. the watch elements. The target hardware is only capable of
        /// monitoring <c>WatchSize</c> watch variables at a time. The array of <c>WatchSize</c> watch elements specifies the watch identifier and
        /// corresponding data value and type for each of the watch elements.
        /// </summary>
        ...
        /// <returns>Zero, if successful; otherwise, an error code.</returns>
        [DllImport("VcuCommunication32.dll")]
        public static extern unsafe short UpdateWatchElements(short forceUpdate, double[] watchValues, short[] watchDataType);
        ...
        #endregion - [VcuCommunication32.dll - Comm Functions] -
    }
}
