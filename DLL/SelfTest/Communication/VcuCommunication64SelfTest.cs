 ...
 *  Project:    SelfTest
 * 
 *  File name:  VcuCommunication64SelfTest.cs
 * 
 *  Revision History
 *  ----------------
 *  Date        Version Author          Comments
 *  02/28/14    1.0     K.McD           1.  First entry into TortoiseSVN. Based upon PTUDLL32.cs but modified to import the PTUDLL64.dll library.
 *  
 *  03/22/15    1.1     K.McD           References
 ...
 *                                      
 *                                      Modifications
 *                                      1.  Renamed class to VcuCommunication64SelfTest. Ref.: 1.1.
 *                                      2.  Changed the DLLImport parameter to VcuCommunication64.dll. Ref.: 1.1.
 *  
 */
...
namespace SelfTest.Communication
{
    ...
    /// Vehicle Control Unit (VCU) when running on a 64 bit platform. VcuCommunication32.dll and VcuCommunication64.dll are functionally 
    /// identical, however, VcuCommunication64 is targeted towards Windows 64 bit operating systems.
    /// </summary>
    public class VcuCommunication64SelfTest
    {
	    ...
	    */
        ...
        /// is passed this way as the size of the InteractiveResults_t structure in C# is different to the value used in VcuCommunication64. Each
        /// element of the array of the InteractiveResults_t structures in VcuCommunication64 consists of a double (8 bytes) followed by an integer
