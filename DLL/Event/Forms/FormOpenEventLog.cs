...
/*
 *  09/30/15    1.15    K.McD       References
 ...
 *                                      
 *                                  Modifications
 *                                  1.  Modified the width of the name and value fields of the 'm_EventVariableControlSize' control by changing the values of the
 *                                      WidthEventControlVariableNameField and WidthEventControlValueField constants to 160 and 140 respectively. This helps the screen
 *                                      to be viewed at a screen resolution of 1024 x 768 without the use of a horizontal scroll bar.
 *                                      
 *                                  2.  Added the WidthLogColumn and WidthEventNameColumn constants to modify the width of the '[Log]' and '[Event Name]' columns
 *                                      of the DataGridView control. This helps the screen to be viewed at a screen resolution of 1024 x 768 without the use of a
 *                                      horizontal scroll bar.
 *                                      
 *                                  3.  Modified the FormOpenEventLog_Shown() method to change the width of the '[Log]' and '[Event Name]' columns of the DataGridView
 *                                      control to the values defined by the WidthLogColumn and WidthEventNameColumn constants respectively.
 *                                      
 *                                  4.  Modified the FormOpenEventLog_Shown() method to include the section of code associated with the '[Event Variables Panel]'
 *                                      region. This code modifies: (a) the 'Width' property of the 'm_PanelEventVariables' control; (b) the 'Size' property of the
 *                                      'm_LegendEventVariables' control and the 'Padding' property of the 'm_PanelEventVariableHeader' control.
 * 
 */
...
namespace Event.Forms
{
    ...
    public partial class FormOpenEventLog : FormViewEventLog, IEventLogFile
    {
        ...
        private void FormOpenEventLog_Shown(object sender, EventArgs e)
        {
            ...
            // Adjust the column widths for the log name and event name to allow the screen to be viewed on a 1024 x 768 resolution screen.
            m_DataGridViewEventLog.Columns[ColumnIndexLog].Width = WidthLogColumn;
            m_DataGridViewEventLog.Columns[ColumnIndexEventName].Width = WidthEventNameColumn;
