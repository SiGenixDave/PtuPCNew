 ...
 *  Project:    Event
 * 
 *  File name:  VcuCommunication64Event.cs
 * 
 *  Revision History
 *  ----------------
 * 
 ...
 *                                      
 *                                          1.  Created from the VcuCommunication32Event class to support 64 bit operating systems, as outlined 
 *                                              in the email to Mark Smorul on 30th May 2014 – PTUDLL32 modifications to support both 32 and 64 bit
 *                                              architecture.
 *
 *                                      Modifications
 *                                      1.  First entry into TortoiseSVN. This file is created from ver. 1.6 of VcuCommunication32Event.cs but has
 *                                          been modified to import the VcuCommunication64.dll library.                                          
 */
...
namespace Common.Communication
{
    ...
    /// <summary>
    /// A managed wrapper class to allow the unmanaged C++ event functions associated with the VcuCommunication64 dynamic link library (DLL) to be 
    /// accessed from within managed code. The VcuCommunication64 DLL supports the low level communication protocol with the 
    /// Vehicle Control Unit (VCU) when running on a 64 bit platform. VcuCommunication32.dll and VcuCommunication64.dll are functionally identical,
    /// however, VcuCommunication64.dll is targeted towards Windows 64 bit operating systems.
    /// </summary>
    public class VcuCommunication64Event
    {
        #region - [VcuCommunication64.dll - Event.cpp Prototypes] -
        /*
        ...
        */
        #endregion - [VcuCommunication64.dll - Event.cpp Prototypes] -

        #region - [VcuCommunication64.dll - Event Functions] -
        /// <summary>
        ...
        [DllImport("VcuCommunication64.dll")]
        ...
        /// <summary>
        /// Get the status of the flags that control: (a) whether the event type is enabled and (b) whether the event type triggers the recoding of
        /// a data stream. 
        /// </summary>
        ...
        /// <returns>Success, if the communication request was successful; otherwise, an error code.</returns>
        [DllImport("VcuCommunication64.dll")]
        public static extern unsafe short GetFltFlagInfo(short[] validFlags, short[] enabledFlags, short[] streamTriggeredFlags, short eventCount);
        ...
        /// <remarks>The size of the <paramref name="cumulativeHistoryCount"/> and <paramref name="recentHistoryCount"/> arrays is equal to the
        /// number of defined event types associated with the current log. The array index is mapped to a table that is derived by sorting the
        /// records of the EVENTS table of the data dictionary corresponding to the LOGID field associated with the current log by the TASKID,
        /// EVENTID fields, in ascending order. </remarks>
        /// <returns>Success, if the communication request was successful; otherwise, an error code.</returns>
        [DllImport("VcuCommunication64.dll")]
        ...
        /// <returns>Success, if the communication request was successful; otherwise, an error code.</returns>
        [DllImport("VcuCommunication64.dll")]
        public static extern unsafe short SetFaultFlags(short taskIdentfier, short eventIdentifier, short enabledFlag, short streamTriggeredFlag);
        ...
        /// <returns>Success, if the communication request was successful; otherwise, an error code.</returns>
        [DllImport("VcuCommunication64.dll")]
        public static extern unsafe short SetDefaultStreamInformation(short watchVariableCount, short sampleMultiple, short[] watchIdentifiers);
        ...
        #endregion - [VcuCommunication64.dll - Event Functions] -
    }
}
