 ...
 *                                  1.  Bug Fix - SNCR - R188 [20-Mar215] Item 29. The file app.config had not been added to the TortoiseSVN repository, consequently,
 *                                      when an attempt is made to build the files that have been checked out of the repository a number of errors are generated.
 *                                              
 *                                  Modifications
 *                                  1.  Added Event/app.config to the 'Visual Studio Solution' repository. - Ref.: 1.
 */
#endregion - [1.24] -

#region - [1.25] -
/*
 *  09/30/15    1.25    K.McD       References
 ...
 *                                      
 *                                  Modifications
 *                                  1.  FormViewEventLog.cs. Rev. 2.3, FormViewEventLog.Designer.cs. Rev. 1.5 - Ref.: 1.
 *                                  2.  FormOpenEventLog.cs. Rev. 1.15. - Ref.: 1.
 * 
 */
#endregion - [1.25] -
